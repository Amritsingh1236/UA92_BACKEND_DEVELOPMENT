...
if (isset($_POST['submit'])) {
 ...
 VALUES ('$Cname', '$Cnumber', '$Ccapacity', '$teacher')";
    ...
    if (mysqli_query($link, $sql)) {
        echo "<b>The class added Successfully</b> ";
    } else {
        echo "<b>Error</b>";
    }
}
        ...
        <div class="container">
            <form action="add_class.php" method="post">
                ...
                <select name="Teacher">
                    ...
                    $sql = mysqli_query($link, "SELECT Teacher_id, Tname FROM teacher");
                    while ($row = $sql->fetch_assoc()) {
                        echo "<option value='{$row['Teacher_id']}'>{$row['Teacher_id']} {$row['Tname']}</option>";
                    }
