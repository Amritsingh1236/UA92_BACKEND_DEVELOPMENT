...
<body>
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO students (Sname, Sbloodgroup, Sgender, Parents_id, Class_id)
    ...
    if (isset($_POST['submit'])) {
        ...
        if (mysqli_query($link, $sql)) {
            echo "<b>The Student Enroled Successfully</b> ";
        } else {
            echo "<b>Error In Adding New Record.</b>";
        }
    }
            ...
            <form action="add_student.php" method="post">
                ...
                <div class="mb-3">
                    ...
                    <select name="Parents">
                        ...
                        $sql = mysqli_query($link, "SELECT Parents_id, Pname FROM parents");
                        while ($row = $sql->fetch_assoc()) {
                            echo "<option value='{$row['Parents_id']}'>{$row['Parents_id']} {$row['Pname']}</option>";
                        }
                    ...
                    <select name="Class">
                        ...
                        $sql = mysqli_query($link, "SELECT Class_id, Class_name FROM class");
                        while ($row = $sql->fetch_assoc()) {
